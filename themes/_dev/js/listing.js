...
$(document).ready(() => {
  ...
  if ($('#category-description p').length == 0) {
	  $('.block-category img').hide();
  }
...
$(window).scroll(function(){
    ...
    var position = startPos > 250 ? '25px' : '-80px'; 
    $('#scroll-top').css( 'bottom', position ); 
...
$(function() {
  ...
  function watchActiveFilters(){
	  var actFilter = $('#js-active-search-filters ul');
...
/*
    var categoryContent = $('#category-description p');
